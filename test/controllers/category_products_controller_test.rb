...
class CategoryProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create category_product" do
    assert_difference('CategoryProduct.count') do
      post category_products_url, params: { category_product: { category_id: @category_product.category_id, product_id: @category_product.product_id } }
    end
  ...
  test "should update category_product" do
    patch category_product_url(@category_product), params: { category_product: { category_id: @category_product.category_id, product_id: @category_product.product_id } }
